					...
					<div class="login-box"
						...
						<div class="login-snips">
							...
							<div class="login-space">
								<div class="login">
								<c:url value="/frmsubmit" var="loginUrl"/>
								...
								<p style="color: #ba0f0f">${errorMessage}</p>
									...
									<form:form action="${loginUrl}" method="post" modelAttribute="User">
										...
										<div class="group">
											...
											<form:input path="username" id="frm_email" cssClass="input my-2" placeholder="Enter your Email" />
										...
										<div class="group">
											...
											<form:input path="password" id="frm_password" type="password" cssClass="input my-2" placeholder="Enter your password" />
											<form:errors path="password" cssClass="error mt-1"></form:errors>
											<span class="error_form" id="password_error_message"></span>
										</div>

										<div class="group">
											<button type="submit" class="button mt-4" value="">Sign In</button>
										</div>
									</form:form>
									<div class="hr"></div>
									<div class="foot">
